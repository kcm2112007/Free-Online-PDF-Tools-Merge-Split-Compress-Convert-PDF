  ...
  runBtn.addEventListener("click", async function () {
    ...
    try {
      ...
      await new Promise(function (resolve, reject) {
        ...
        setTimeout(function () { reject(new Error("Rendering timed out")); }, 30000);
      });
      ...
      console.error(err);
      C.showMsg(msg, "Couldn't convert this document: " + err.message, "error");
    } finally {
...
function mount_pdf_ocr(root) {
  ...
  runBtn.addEventListener("click", async function () {
    ...
    try {
      ...
      console.error(err);
      C.showMsg(msg, "OCR failed: " + err.message, "error");
    } finally {
